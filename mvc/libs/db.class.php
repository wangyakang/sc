...
class db
{
    public $hostname = "sqld.duapp.com";
    private $username = "1250de1ae4c64a30ab3b2c43b3a97480";
    private $password = "a021088022984534a76974f520675d10";
    public $dbname = "gdHTabCAwDUvFskaUieR";
    public $opts;
    public $tablename = "";
    public $connect;
    /*  早绑定  弱类型 严谨  强制类型*/
    ...
    function config()
    {
        $this->connect = new mysqli($this->hostname, $this->username, $this->password, $this->dbname,4050);
